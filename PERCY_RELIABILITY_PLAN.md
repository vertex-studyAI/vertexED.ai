...
| Experiment ledger | **KEEP/CANONICALIZE** | one protocol/version/hash/failed-run lineage; no conflicting second registry |
...
| Semantic deduplication | **AFTER CANONICAL SCHEMA** | reviewed duplicate/non-duplicate fixtures; distinct hypotheses never merged by textual similarity alone |
