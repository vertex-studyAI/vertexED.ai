...
export default function Main() {
  ...
  const tiles: Tile[] = [
    ...
    { title: "Exam Hub ✨ New", to: "/exam-hub", info: "Coming soon — a dedicated war-room for exam season prep, mocks and live drills.", icon: examIcon() },
...
function examIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <path d="M12 2l2.39 4.84L20 8l-4 3.9.94 5.5L12 14.77 7.06 17.4 8 11.9 4 8l5.61-1.16L12 2z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" />
    </svg>
  );
}
