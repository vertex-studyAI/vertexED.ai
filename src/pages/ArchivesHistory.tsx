  ...
  return (
    <>
      <Helmet>
        <meta
          name="description"
          content="History archive: timelines, primary sources and model answers (IB MYP focus)."
        />
        <title>History — Archives | VertexED</title>
      </Helmet>
      ...
      <section className="min-h-screen px-6 py-16 bg-gradient-to-b from-slate-900 to-slate-800 text-slate-100">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-300 mb-6 text-sm">
            Curated History notes and exemplar answers for IB MYP support. Add timelines, primary-source excerpts,
            source analysis notes, and model responses.
          </p>
          ...
          <div className="rounded-md border border-slate-700 bg-slate-900 p-6 text-slate-300">
            ...
            <p className="text-sm mb-4">
              No History content yet. Paste units, timelines and source analyses below when ready.
            </p>
