...
<h1 className="text-3xl sm:text-4xl font-semibold">Language &amp; Literature — Archives</h1>
...
Repository for Language &amp; Literature notes and curated sample answers — close readings, annotated
excerpts and sample essays for IB MYP support.
</p>
...
<p className="text-sm mb-4">No LnL content yet. Add headings, excerpts, and model responses here. Use clear subheadings to keep the archive organized.</p>
...
<Link to="/archives/geography" className="inline-flex items-center gap-2 rounded-2xl px-4 py-2 text-sm bg-white/5 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500">Geography</Link>
</div>
</div>
</div>
</section>
