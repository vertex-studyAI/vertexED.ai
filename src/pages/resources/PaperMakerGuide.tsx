...
export default function PaperMakerGuide() {
  ...
  <BreadcrumbsJsonLd />
      <Article title="IB and IGCSE Paper Maker" subtitle="Board-shaped mocks by topic — export, attempt under time, review against mark schemes." kicker="Guides">
        ...
        <h2>FAQ</h2>
        <p><strong>Are these real past paper questions?</strong> They are "style-alike" questions generated by AI to avoid copyright issues, but they match the difficulty, format, and command terms of real exams.</p>
        <p><strong>Can I print them?</strong> Yes, you can export any generated paper to PDF for offline practice under exam conditions.</p>
        <p><strong>Does it include mark schemes?</strong> Each paper includes an AI-generated reference rubric. Treat it as provisional practice guidance and compare it with your teacher&apos;s or exam board&apos;s official mark scheme.</p>
