  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Board-specific study guides — command words, pacing, common mark losses, and revision order. Generated per topic and cached on your device."
        />
      ...
      <PageSection className="max-w-5xl space-y-8 portal-rise">
        ...
        <header className="immersive-hero rounded-2xl border border-border/60 p-8 md:p-10">
          ...
          <p className="text-muted-foreground max-w-2xl text-base leading-relaxed">
            Long-form guides for IB, AP, IGCSE, ICSE, GCSE, and A Level topics — how examiners allocate marks,
            where students lose points, and a sensible revision order. Each guide is generated once per topic and saved locally.
          </p>
        </header>
