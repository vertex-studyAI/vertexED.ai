...
export default function FluidCursor(props: Props) {
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvasEl: HTMLCanvasElement) {
      ...
      if (!gl) {
        console.warn("Unable to initialize WebGL for FluidCursor.");
    ...
    window.addEventListener("touchstart", onTouchStart, { passive: true } as EventListenerOptions);
    window.addEventListener("touchmove", onTouchMove, { passive: true } as EventListenerOptions);
    window.addEventListener("touchend", onTouchEnd, { passive: true } as EventListenerOptions);
