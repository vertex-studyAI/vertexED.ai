...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor() {
      // Mostly grayscale with occasional accent blue splash
      const isAccentBlue = Math.random() < 0.35; // 15% chance for accent blue
      if (isAccentBlue) {
        // Brand blue (#4A9BB8 / HSL 199 45% 50%) - brightened for visibility
        return { r: 0.07, g: 0.15, b: 0.18 };
      }
      // Grayscale (black, white, shades of grey)
      const gray = Math.random() * 0.25;
