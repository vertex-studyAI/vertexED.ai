...
const CENTERED_OVERLAY =
  "fixed inset-0 z-[70] flex items-center justify-center overflow-y-auto bg-black/85 p-4 backdrop-blur-sm";
const FULL_SCREEN_OVERLAY = "fixed inset-0 z-[70] bg-background";
