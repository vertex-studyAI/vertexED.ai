...
export default function SiteLayout() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="pointer-events-none absolute inset-0 z-0 bg-[radial-gradient(circle_at_top,_hsl(var(--primary)/0.16),_transparent_36%),radial-gradient(circle_at_bottom_right,_hsl(var(--accent)/0.10),_transparent_28%),linear-gradient(180deg,_hsl(var(--background)),_hsl(var(--background)/0.94))]" />
      ...
      <footer className="relative z-10 border-t border-white/8 bg-black/20 backdrop-blur-xl">
        <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-4 px-4 py-6 text-sm text-white/60 md:flex-row md:items-center md:justify-between md:px-6">
          <p>Vertex AI — built for focused study, adaptive practice, and calmer planning.</p>
