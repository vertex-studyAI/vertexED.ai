...
**Rule:** negative/mixed evidence may be VERIFIED; this never means superiority, external validation or publication.
...
| IRIS v0.2 | **VERIFIED mixed/negative; PARTIAL exact source recovery / frontier BLOCKED** | recover exact canonical dev trajectories + exact frozen adaptation-metric provenance; seeds `1000–1029` forbidden |
...
| Darcy T2424-0050 | **v2 FROZEN / PARTIAL PRE-OUTCOME / NOT RUN** | B2 PCA+ridge merged `86170b1a6bb8fbc1484f99fd680876c271fb5474`; safety `daf548fa...`; training remains unauthorized. Close two interpretation approvals, B3 FNO, B4 DeepONet, environment/hardware/budgets and final manifests before training/ID/OOD outcome access |
...
| NPMS | **VERIFIED controlled source / PARAMETER-CONFOUNDED OR NON-UNIQUE** | controlled Atlas source SHA `076f12750d6a8e6c298c17815224a79463bcad149d6cf1283900d98c6e394a2c`; clean replay; NPMS `92.86%` vs invariant-parameter `89.29%`, gap `3.57` pp < frozen 5-pp non-uniqueness threshold. Source recovery is closed; freeze a new natural/causal protocol with invariant-parameter + state-space/spectral controls before any run |
