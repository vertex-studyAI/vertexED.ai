...
- The final portfolio-control refresh is documentation/status only and is being verified from the current `main` after the two-file truth-ledger PR #217 landed.
