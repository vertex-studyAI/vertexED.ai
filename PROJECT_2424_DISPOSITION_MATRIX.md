...
|---|---|---:|---|
| T2424-0025 | bounded effect reproduces; clean control also benefits, so unique mechanism is not isolated | **C** | separately frozen learned-memory causal control |
| T2424-0027 | synthetic result only; real representation transfer unestablished | **C** | preregistered real-encoder probes + controls |
