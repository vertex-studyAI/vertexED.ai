...
|---|---|---|
| LAM-JEPA | **PARTIAL** | Internal negative-result/reproduction packet is VERIFIED. PR `vertex-studyAI/LAM-JEPA#88` explicitly records owner-blocked license/redistribution, authorship/order and `CITATION.cff`; external validation remains none returned. |
...
| VertexED | **BLOCKED** | Source identity contract is VERIFIED at `d52308a`, but no post-fix served production identity or authenticated disposable-account journey is verified. |
