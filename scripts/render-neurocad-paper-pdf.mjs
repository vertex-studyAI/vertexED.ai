...
<head>
<meta charset="utf-8">
<title>NeuroCAD bounded historical and mechanism-falsification manuscript</title>
<style>
...
async function main() {
  ...
  if (!manuscriptPath || !outputPath) {
    throw new Error('Usage: node scripts/render-neurocad-paper-pdf.mjs <MANUSCRIPT.md> <paper.pdf>');
  }
