...
analysis, stopping rules and publication boundaries. The evidence registry records 696
...
`docs/PILOT_PROTOCOL.md`, `evidence/status.json`, and
`evidence/FINAL_TRUTH_MATRIX.md`, plus `evidence/stage_01` through `stage_12` in Markdown
and JSON.

Truth boundary: `DEPLOYED_VERIFIED=false` and `OUTCOME_VERIFIED=false`. No test count,
