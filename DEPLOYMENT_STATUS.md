...
| The Bu1LD | `ryangomez010/bu1ld-landing@daa80c1124b2a6d7d09b7669e04d29e50cffcbbe`; exact-main CI run `29679123068` PASS | Cloudflare run `29679123047` failed at `release:check`; deploy job skipped | **BLOCKED — DEPLOYMENT NOT VERIFIED** | fix/diagnose release check, rerun intended SHA, prove served revision, then seven-role journey |
