...
Clean controlled replay preserved the source archive and returned:
...
Historical NPMS bundles remain distinct historical/derived packages and are not silently substituted for this checksum-matched Atlas source.
