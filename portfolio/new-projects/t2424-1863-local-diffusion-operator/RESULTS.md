...
Synthetic one-step diffusion only; scalar learned coefficient; no long rollout; no real PDE data; no strong neural-operator baseline; no runtime/memory measurement beyond locality; independent QA pending.
