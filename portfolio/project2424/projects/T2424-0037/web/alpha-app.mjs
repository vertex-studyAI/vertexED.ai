...
function objectX(object) {
  return object.transform?.translate?.[0] ?? 0;
}
...
function renderValidation() {
  el("validation-status").textContent = "PASS";
  el("validation-copy").textContent = "Validated CADDocument · bounded conceptual geometry · no manufacturing or propulsion claims";
}
