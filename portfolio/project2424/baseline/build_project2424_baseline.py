...
AUDITED = {
    "T2424-0027": {
        ...
        "hypothesis_status": "FALSIFIABLE_FROZEN",
        "protocol_status": "FROZEN_SYNTHETIC_V3_SEPARATE",
        "dataset_status": "SYNTHETIC_RETAINED_V3_REAL_DATA_PINNED",
        "baseline_status": "CONTROLLED_PRIOR_ART_OVERLAP",
        "test_status": "TESTED",
        "experiment_status": "SYNTHETIC_EXECUTED_V3_OUTCOME_BLOCKED",
        "reproduction_status": "SYNTHETIC_INDEPENDENT_REPRODUCED",
        "scientific_verdict": "PASS_CONTROLLED_LANGUAGE_LEAKAGE_MECHANICS_V3_PENDING",
        "evidence_strength": "STRONG_BOUNDED",
        "literature_status": "CURRENT_PRIMARY_AUDIT_COMPLETE",
        "manuscript_status": "ASSEMBLED",
        "release_status": "NO_GO_AUTHORIZATION_CI_AUTHOR_LICENSE_PDF",
        "readiness_score": "89",
        "readiness_band": "PREPRINT_CANDIDATE",
        "disposition": "HOLD_FOR_FROZEN_V3_GATE",
        "exact_blocker": "V3 exact-head authorization/CI and outcome remain unresolved; synthetic evidence cannot support a real multilingual claim",
        "exact_next_action": "Repair or rerun only the frozen v3 authorization workflow without changing scientific fields; retain the one-shot outcome unchanged",
