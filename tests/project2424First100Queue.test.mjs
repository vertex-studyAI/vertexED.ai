...
// T2424-0050 is repaired on this branch and the PST/NPMS canonical
// recovery identities are now explicit on main. Any remaining mismatch
// must therefore fail closed rather than be normalized or silently counted.
