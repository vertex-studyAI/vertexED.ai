...
// T2424-0050 is repaired on this branch and PST/NPMS canonical recovery
// identities are explicit on main. Any remaining package/queue mismatch
// must fail closed rather than be normalized or silently counted.
