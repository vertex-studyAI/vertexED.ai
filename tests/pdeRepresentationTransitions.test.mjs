...
import {
  ...
  projectSineModes,
  sweepDiffusivity
} from "../portfolio/new-projects/representation-phase-transitions-for-pdes/src/core.mjs";
...
test("diffusion sweep reduces effective spectral representation dimension on the controlled multimode state", () => {
