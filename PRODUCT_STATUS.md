...
| The Bu1LD source | **GREEN — EXACT CURRENT-MAIN CI PASSED** | `ryangomez010/bu1ld-landing` current `main` = `daa80c1124b2a6d7d09b7669e04d29e50cffcbbe`; exact-main CI passed | preserve exact SHA; diagnose the separate release/deployment gate |
| The Bu1LD production | **BLOCKED — DEPLOYMENT NOT VERIFIED** | Cloudflare workflow on exact current main failed in its verification job because `release:check` exited 1; deployment job was skipped. Source CI is not production proof. | fix/diagnose exact release-check failure, rerun on intended SHA, prove immutable served revision, then certify hydration, RLS/roles and seven-role authenticated journey |
