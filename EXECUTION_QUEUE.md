...
| VX-202 | P0 | Certify branch in canonical GitHub CI | Branch/PR and CI workflow | GitHub API/Git transport reachable | Current-main run `34210010861`: source/build + local browser pass; production browser/smoke fail and are routed to VX-203 | Low | MEDIUM | Build/test and local browser checks pass; production smoke truth is retained rather than hidden | DONE |
