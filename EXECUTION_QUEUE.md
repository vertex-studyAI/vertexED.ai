...
| VX-202 | P0 | Certify branch in canonical GitHub CI | Branch/PR and CI workflow | Push/PR authority | Required checks green on exact SHA; run URL retained | Low | MEDIUM | Build/test and browser jobs pass; smoke truth reported | TODO |
