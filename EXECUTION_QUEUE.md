...
| VX-206 | P1 | Add browser coverage for adaptive notes and mock review | Playwright golden journey | Deterministic auth preview | Enter weakness, follow action, see evidence label, submit mock | UX/regression | MEDIUM | Forged target rejected; mock completion creates no score | DONE |
