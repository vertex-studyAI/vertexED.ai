...
The source-side production identity contract is now isolated in PR `#397` at `8cf6c65d1786358e902952c5dee4e1250be9948b`: production health fails closed when no immutable revision is resolvable rather than returning healthy without identity. Exact-head CI `31861346546` succeeds. This does not certify production because the source is unmerged/unproved on the served deployment and the authenticated disposable-account journey remains open.
