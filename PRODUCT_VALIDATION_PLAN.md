...
Two-week clock starts only after canonical repo + Supabase/backend access exists: 1–3 security/denial matrix; 4–5 disposable member/admin journeys; 6–12 small real discovery-to-participation test; 13–14 decide `VALIDATE_NEXT_WORKFLOW`, `SECURITY_REPAIR`, or `REDESIGN/ARCHIVE`.
...
Two-week clock starts only after canonical source/deploy/backend access: 1–3 release/role audit; 4–6 disposable multi-role journeys; 7–12 small real contribution/application + review cycle; 13–14 decide `CORE_WORKFLOW_VALIDATED`, `ROLE_OR_RELIABILITY_REPAIR`, or `REDESIGN/ARCHIVE`.
